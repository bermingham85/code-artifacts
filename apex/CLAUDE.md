...
3. Use `docs/APEX_WORKSPACE_MENU.md` to understand loose artifact groups without opening every file.
4. Use `registry/TOOL_INDEX.md` for approved callable tools.
5. Use `docs/DOCUMENT_REGISTER.md` for governed artifact paths and status.
6. Load full specs only when the task requires implementation detail.
